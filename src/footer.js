...
<footer class="bg-gradient-to-r from-indigo-900 via-volet-900 to-fuchsia-900 ...">
  ...
  <div class="text-center p-6 bg-gray-700">
    ...
    <a class="text-black font-semibold" href="https://tailwind-elements.com/">Retro Garage</a>
  </div>
</footer>
    )}